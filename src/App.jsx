    ...
    <aside className="perfil">
      <div className="container">
        ...
        <section className="sobre-mi">
          <h2>SOBRE MÍ</h2>
          <p>
            Frontend Developer formado en Digital House con stack React.
            Ampliando conocimientos en backend con Node.js y SQL. Proactivo,
            orientado a resultados y con rápida capacidad de adaptación.
          </p>
        </section>
      </div>
    </aside>
